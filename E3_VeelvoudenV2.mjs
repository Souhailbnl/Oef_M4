...
let deelbaar1 = parseFloat(await userInput.question('Is het deelbaar door deler1'));
let deelbaar2 = parseFloat(await userInput.question('Is het deelbaar door deler2'));
